function [Xhat,it] = callLMaFit(XO,params)
% Call it as:
% [err,mu,it,time] = runExperiment(d,N,ell,rangeMu,method,[r,tol,maxIter]);
% [err,mu,it,time] = runExperiment(100,100,40,[5,6],@callLMaFit,[5,1e-12,1000]);
r = params(1);
opts.tol = params(2);
opts.maxit = params(3);
opts.est_rank = 0;
...
[A,B,out] = lmafit_mc_adp(d,N,r,O,data,opts);
